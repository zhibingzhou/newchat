...
[![star](https://img.shields.io/github/stars/woodylan/go-websocket?style=social)](https://websocket/stargazers)
...
1. PHP版：https://websocket-php-sdk
...
<https://websocket/releases>

**你也可以选择自己编译：**

```shell
git clone https://websocket.git
```
